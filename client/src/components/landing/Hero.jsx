// File name: Hero
// File name with extension: Hero.jsx
// Full path: E:\cloud_ShubhamJadhav\client\src\components\landing\Hero.jsx
...
const Hero = () => {
  return (
    <>
      <section
        className="section "
        style={{ backgroundImage: `url(${image})`, height: "648px" }}
      >
        <div className="w-[32rem] text-black pt-44 pl-24">
          <h2 className="font-light text-5xl">New Summer</h2>
